...
// MFCApplicationClient.cpp: определяет поведение классов для приложения.
//
...
// Создание CMFCApplicationClientApp
...
// Единственный объект CMFCApplicationClientApp

CMFCApplicationClientApp theApp;


// Инициализация CMFCApplicationClientApp
...
BOOL CMFCApplicationClientApp::InitInstance()
{
	...
	GdiplusStartupInput gdiplusStartuoInput;
	GdiplusStartup(&gdiplus_th, &gdiplusStartuoInput, NULL);
